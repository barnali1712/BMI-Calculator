...
# two boxes
tkinter.Label(root, width=20, height=10, bg="grey").place(x=20, y=100)
tkinter.Label(root, width=20, height=10, bg="grey").place(x=240, y=100)

# scale
tkinter.Label(root, width=25, height=10, bg="grey").place(x=20, y=310)
...
def slider_c(event):
    ...
    man.config(width=10, height=5, bg="grey")
    man.place(x=70, y=530 - size)
